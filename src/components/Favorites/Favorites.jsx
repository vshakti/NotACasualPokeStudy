...
export function Favorites({
  ...
  return (
    <dialog className="modal" id="main_modal_2">
      <DexBG bodyStyle="bg-gradient-to-t from-bg-slate-950 via-slate-800 to-bg-slate-950 gap-y-6 max-w-96 pb-1 min-w-80">
        <DexLine
          bodyLineStyle="border-t-0"
          bodyLinePlacement="w-full border-r-0 border-l-0 mb-0 rounded-b-none h-16"
        >
            ...
            <form method="dialog">
              <button className="size-10 text-white mt-3.5">
                <XMarkIcon
                  ...
                  className="hover:scale-150 transition easy-in-out"
                />
              </button>
            </form>
          </div>
            ...
            {favorites && favorites.length > 0 ? (
              <>
                ...
                {filteredFavorites.length > 0 ? (
                        ...
                        >
                          ...
                          <img
                            onClick={() => {
                              ...
                              document
                                .getElementById("pokemon_details")
                                .showModal();
                            }}
                            src={pokemon.sprite}
                            alt={pokemon.name}
                  ...
                  <div className="pb-6">
                    <span className="text-white animate-pulse font-medium text-xl px-2 py-1 rounded-xl border-b-2">
