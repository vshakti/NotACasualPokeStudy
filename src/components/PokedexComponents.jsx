function DexBG({ children, bodyStyle, bodyGradient }) {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex flex-col justify-center items-center">
      <div
        className={`flex-col space-y-6 rounded-3xl items-center overflow-hidden shadow-[0_0px_50px_5px_black] border-0.75 border-double border-slate-900 flex ${bodyStyle}`}
        style={{
